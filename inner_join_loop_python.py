...
#so as to inner join them based on their sample type (i.e PD for progressive disease) 
#dependent on file nomenclature
#in code below set to inner join PD_path matrices, easily modifiable for other dirs
